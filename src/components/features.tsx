...
export const BentoCard = ({
    ...
    return (
        <div className="relative size-full">
            ...
            />
            <div className="absolute left-0 top-0 z-10 size-full bg-black/40 object-cover object-center" />
            <div className="relative z-20 flex size-full flex-col justify-between p-5 text-blue-50">
                <div>
        ...
        <section className="bg-black pb-52">
            <div className="container mx-auto px-3 md:px-10">
                ...
                <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
                    <BentoCard
                        src="https://ik.imagekit.io/sharull/zentry/videos/feature-1.mp4"
                        title={
                            <>
                                radia<b>n</b>t
                            </>
                ...
                <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
                    <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
                        <BentoCard
                            src="https://ik.imagekit.io/sharull/zentry/videos/feature-2.mp4"
                            title={
                                <>
                                    zig<b>m</b>a
                                </>
                    ...
                    <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
                        <BentoCard
                            src="https://ik.imagekit.io/sharull/zentry/videos/feature-3.mp4"
                            title={
                                <>
                                    n<b>e</b>xus
                                </>
                    ...
                    <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
                        <BentoCard
                            src="https://ik.imagekit.io/sharull/zentry/videos/feature-4.mp4"
                            title={
                                <>
                                    az<b>u</b>l
                                </>
                    ...
                    <BentoTilt className="bento-tilt_2">
                        <video
                            src="https://ik.imagekit.io/sharull/zentry/videos/feature-5.mp4"
                            loop
                            muted
                            autoPlay
